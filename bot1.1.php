...
echo $M2." ? \033[1;37m NH?P PASSWORD : ".$M2;
$p = trim(fgets(STDIN));
...
if($pass == $p){
        ...
        fclose($save);
        sleep(2);
        echo " ? Ð?NG QUÊN CÀ PHÊ..!! THU?NG TH?C CÔNG VI?C C?A B?N\n";
        sleep(3);
        }else{
        echo $M2." ? LOGIN TH?T B?I, HÃY KI?M TRA L?I M?T KH?U\n";
        exit;
        }
        }
}
...
echo"\n\n B?t d?u ch?y tool Xem qu?n cáo\n";
echo$yellow2."....\n==============================\n\n";
